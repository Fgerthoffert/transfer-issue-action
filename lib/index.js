...
async function run() {
  try {
    ...
    const createLabelsIfMissing = JSON.parse(core.getInput('create_labels_if_missing'))
    ...
    console.log('will transfer issue to %s if %s matches %s', targetRepoName, triggerLabel, sourceLabel.name)
    console.log(parts)
